...
export default function PropertyClause({
  ...
  const resolvedLegalDescription =
    legalDescription?.trim() || 'the legal description of the Property';
  ...
  return (
    <section>
      ...
      <p>
        ...
        <strong>{resolvedAddress}</strong>, further described as{' '}
        <strong>{resolvedLegalDescription}</strong>.
      </p>
    </section>
  );
}
