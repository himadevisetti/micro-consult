        ...
        {config.type === 'number' ? (
          ...
          <div className={styles.workScheduleBlock}>
            {(() => {
              ...
              return (Array.isArray(value) && value.length > 0 ? value : [{}]).map((entryRaw, idx) => {
                  ...
                  <div key={idx} className={styles.workScheduleEntry}>
                    ...
                    <div className={styles.daysFieldWrapper}>
                      {daysField && daysField.options && (
                        <>
                          <select
                            name={`workSchedule_row_${idx}_days`}
                            className={styles.select}
                            multiple
                          ...
                          {!errors?.workSchedule && getError(`workSchedule_row_${idx}_days`) && (
                            <span className={styles.error}>{getError(`workSchedule_row_${idx}_days`)}</span>
                          )}
                        </>
                      )}
                    ...
                    {timeRangeField && (
                      <>
                        <div className={styles.timeRange}>
                          <select
                            name={`workSchedule_row_${idx}_start`}
                            className={styles.select}
                          ...
                          <select
                            name={`workSchedule_row_${idx}_end`}
                            className={styles.select}
                        ...
                        {!errors?.workSchedule && (
                          getError(`workSchedule_row_${idx}_start`) ||
                          getError(`workSchedule_row_${idx}_end`)
                        ) && (
                            <span className={styles.error}>
                              {getError(`workSchedule_row_${idx}_start`) || getError(`workSchedule_row_${idx}_end`)}
                            </span>
                          )}
                      </>
                    )}
