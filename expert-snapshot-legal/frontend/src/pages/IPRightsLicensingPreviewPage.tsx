// src/pages/IPRightsLicensingPreviewPage.tsx

import React, { useEffect } from 'react';
import { useLocation, useNavigate, useParams } from 'react-router-dom';
import IPPreview from '../components/AgreementPreview/IPPreview';
...
export default function IPRightsLicensingPreviewPage() {
  ...
  const { type } = useParams(); // 'ip-rights-licensing', etc.
  const formType = type as FormType;

  const formData = location.state?.formData as IPRightsLicensingFormData;
