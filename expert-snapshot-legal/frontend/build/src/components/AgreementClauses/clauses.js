...
export function getClauses(formData) {
    return [
        _jsx(PartiesClause, { clientName: formData.clientName, providerName: "Expert Snapshot Legal", effectiveDate: formData.startDate }, "parties"),
        _jsx(ScopeClause, { matterDescription: formData.matterDescription }, "scope"),
        _jsx(ResponsibilitiesClause, {}, "responsibilities"),
        _jsx(CommunicationClause, { clientName: formData.clientName }, "communication"),
        _jsx(FeeClause, { structure: formData.feeStructure, feeAmount: "350", retainerAmount: "1500", jurisdiction: formData.jurisdiction }, "fee"),
